...
class CWebUser extends CApplicationComponent implements IWebUser
{
	 ...
	 * to construct the login URL (e.g. array('/index/login')). If this property is null,
	 * a 403 HTTP exception will be raised instead.
	 * @see CController::createUrl
	 */
	public $loginUrl=array('/index/login');
	/**
	 ...
	 * since the user visits the index the last time.
	 * @see allowAutoLogin
	 * @since 1.1.0
	 */
