 ...
 * assume {@link defaultController} is requested (which defaults to 'index').
 *
...
{
	/**
	 * @return string the route of the default controller, action or module. Defaults to 'index'.
	 */
